    ...
    <>
      <div className="app-about-area pb-100">
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 col-md-12">
              <div className="app-about-image">
                <img src="/images/home-7-8-9/about/about.png" alt="image" />
              </div>
            </div>

            <div className="col-lg-6 col-md-12">
              <div className="app-about-content">
                <div className="big-text">Ebitukwata Ko</div>
                <span className="sub-title">Ebitukwata Ko</span>
        ...
        <div className="app-about-shape-1">
          <img src="/images/home-7-8-9/about/shape-1.png" alt="image" />
        </div>
        <div className="app-about-shape-2">
          <img src="/images/home-7-8-9/about/shape-2.png" alt="image" />
        </div>
        <div className="app-about-shape-3">
          <img src="/images/home-7-8-9/about/shape-3.png" alt="image" />
        </div>
      </div>
    </>
  );
